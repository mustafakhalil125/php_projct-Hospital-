     ...
     <!-- list all doctors -->
              ...
              <div class="container mt-5 mb-5">
                  <div class="doctor-card row ">
                      <div class="doctor-card-image col-md-4">
                          <img src="admin/admin/img/<?php echo $row['image'] ?>" class="d-block w-100" alt="Doctor Image">
                      </div>
                      <div class="doctor-card-body col-md-8">
                          <h2 class="mt-0 text-danger"><?php echo $row['name'] ?></h2>
                          <h4 class="text-muted"><?php echo $row['kind'] ?></h4>
                          <h4 class="">Description</h4>
                          <p class="mt-2"><?php echo $row['description'] ?></p>
                          <a href="appointment.php">
                            <button class="btn btn-danger mt-3">Book Appointment</button>
                          </a>
                      </div>
                   </div>
               </div>
