...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container">
               <img src="/hospital/images/<?php echo $row['image'] ?>" class="rounded-circle" width="150" height="150" alt="" srcset="">
               ...
               <hr class="sidebar-divider d-none d-md-block">
                ...
                <hr class="sidebar-divider d-none d-md-block">
                <a href="/hospital/update-profile.php?id=<?php echo $row['id']?>&update"><button type="button" class="btn btn-success">Edit Profile</button></a>
