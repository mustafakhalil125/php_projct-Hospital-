...
if(isset($_POST['submit']))
{
    ...
    $update =" UPDATE `admin login` SET `id`='',`email`='$email',`password`='$password',`name`= '$profile',`image`='$filename' WHERE id = '$id'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <?php 
                    $id = $_GET['id'];
                    $select= "select * from `admin login` where id='$id' ";
                ...
                <div class="container">
                    <form method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label >Name</label>
                            <input type="text" class="form-control" value="<?php echo $row['name'] ?>" name="profile-name"  placeholder="your name">
                        </div>
                        <div class="form-group">
                            <label >Image</label>
