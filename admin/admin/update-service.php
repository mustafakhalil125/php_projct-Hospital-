...
if(isset($_POST['submit']))
{
    ...
    $update ="UPDATE `services` SET `id`='',`image`='$filename',`service`='$service',`detail`='$detail',`doctor`='$doctor' WHERE id = '$id'";
...
<textarea name="detail" class="form-control" id=""><?php echo $row['detail'] ;?></textarea>


<label for="">Docter</label>
<select class="form-control" name="doctor">
  <option value="<?php echo $row['doctor']; ?>" ><?php echo $row['doctor'] ;?></option>
