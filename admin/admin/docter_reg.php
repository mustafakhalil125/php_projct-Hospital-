...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO `docter_reg` VALUES ('','$name','$kind','$email','$password','$description','$filename')";
...
<body id="page-top">
    ...
    <a class="scroll-to-top rounded" href="#page-top">
     ...
     <button type="submit" name="submit" class="btn bg-gradient-danger mt-4 text-gray-100">Create Account</button>
    </form>
