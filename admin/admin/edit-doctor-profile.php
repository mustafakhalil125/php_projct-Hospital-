...
if(isset($_POST['submit']))
{
    ...
    $update =" UPDATE `docter_reg` SET `id`='$id',`name`='$name',`kind`='$kind',`email`='$email',`password`='$password',`description`='$description',`image`='$filename' WHERE id ='$id'";
    $run = mysqli_query($connect , $update);
    if($run){
     header('location:/hospital/admin/docter/doctor_profile.php');
    }else{
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed " href="/hospital/admin/docter/doctor_profile.php" >
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="/hospital/admin/docter/view_appointment.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="/hospital/admin/docter/doctor-profile.php">
                    ...
                    $id = $_GET['id'];
                    $select = "select * from `docter_reg` where id = '$id' ";
     ...
     <form action="" method="post" class="container"  enctype="multipart/form-data">
      ...
      <input type="password" name="password" class="form-control" placeholder="Create password" value="<?php echo $row['password'] ?>">
       
      <label for="">Kind of Docter</label>
      <select class="form-control" name="kind">
       <option value="<?php echo $row['kind'] ?>"  ><?php echo $row['kind'] ?></option>
        <option value="General Practitioners (GPs)"  >General Practitioners (GPs)</option>
     ...
     <button type="submit" name="submit" class="btn bg-gradient-danger mt-4 text-gray-100">Update</button>
    </form>
