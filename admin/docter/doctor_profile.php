...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed " href="doctor_profile.php" >
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="/hospital/admin/admin/img/<?php echo $user_image ?>">
                            </a>
            ...
            ?>
            <div class="container">
               <img src="/hospital/admin/admin/img/<?php echo $row['image'] ?>" class="rounded-circle" width="150" height="150" alt="" srcset="">
               ...
               <hr class="sidebar-divider d-none d-md-block">
                ...
                <h5 class="text-dark"><?php echo $row['email'] ?></h5>

                <hr class="sidebar-divider d-none d-md-block">
                <label for="">password</label>
                <h5 class="text-dark"><?php echo $row['password'] ?></h5>

                
                <hr class="sidebar-divider d-none d-md-block">
                <label for="">Kind of Doctor</label>
                <h5 class="text-dark"><?php echo $row['kind'] ?></h5>
                ...
                <hr class="sidebar-divider d-none d-md-block">
                <a href="/hospital/admin/admin/edit-doctor-profile.php?id=<?php echo $row['id']?>&update"><button type="button" class="btn btn-success">Edit Profile</button></a>
