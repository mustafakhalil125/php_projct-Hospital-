...
if(isset($_POST['submit']))
{
   ...
   $query = "select * from `docter_reg` where email = '$email' AND password = '$password'";
   ...
   if(mysqli_num_rows($run)>0)
   {
    ...
    window.location.href = 'doctor_login.php';  // Wapis usi page per redirect karain
    </script>";
   }
    ...
    <div class="container">
        <div class="login-container">
            ...
            <form method="post">
                ...
                <button type="text" class="btn btn-danger btn-block"><a href="patient-login.php">patient Login</a></button>
